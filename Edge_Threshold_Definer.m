classdef Edge_Threshold_Definer < handle
    ...
    methods
        function [obj]=Edge_Threshold_Definer(DATA,X)
            ...
            % Creating 'threshold_txt' text
            uicontrol(...
            'Units','normalized',...
            'Position',[0.8 0.35 0.1 0.03],...
        ...
        function OK_Callback(obj, hObject, eventdata)
            obj.Threshold_value=str2double(get(obj.WEIGHT_THRESHOLD,'String'));
            close(obj.figID)
        end
