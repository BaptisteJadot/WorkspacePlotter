...
new_r = [];
new_r = [new_r diff_mean(exp.readout,range1,range2,1,'ADC0_2 - ADC0_1')];
new_r = [new_r diff_mean(exp.readout,range1,range3,1,'ADC0_3 - ADC0_1')];
new_r = [new_r diff_mean(exp.readout,range2,range3,1,'ADC0_3 - ADC0_2')];
new_r = [new_r diff_mean(exp.readout,range1,range2,2,'ADC1_2 - ADC1_1')];
new_r = [new_r diff_mean(exp.readout,range1,range3,2,'ADC1_3 - ADC1_1')];
new_r = [new_r diff_mean(exp.readout,range2,range3,2,'ADC1_3 - ADC1_2')];
