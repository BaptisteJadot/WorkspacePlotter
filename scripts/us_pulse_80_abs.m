...
range2 = 37:51;
range3 = 64:80;
obj = abs_mean(obj,range1,1,'ADC0_1');
obj = abs_mean(obj,range2,1,'ADC0_2');
obj = abs_mean(obj,range3,1,'ADC0_3');
obj = abs_mean(obj,range1,2,'ADC1_1');
obj = abs_mean(obj,range2,2,'ADC1_2');
obj = abs_mean(obj,range3,2,'ADC1_3');
