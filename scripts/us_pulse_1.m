...
newLSD.Nstep2 = 1;
newLSD.Nmeasure = size(oldLSD.data,4);
...
newLSD.data(:,:,1,2) = squeeze(mean(oldLSD.data(range2,:,:,2),1)-mean(oldLSD.data(range1,:,:,2),1));
...
newLSD.measure_dim.used_param_number = oldLSD.measure_dim.used_param_number;
newLSD.measure_dim.param_infos = oldLSD.measure_dim.param_infos;
newLSD.measure_dim.param_values = oldLSD.measure_dim.param_values;
